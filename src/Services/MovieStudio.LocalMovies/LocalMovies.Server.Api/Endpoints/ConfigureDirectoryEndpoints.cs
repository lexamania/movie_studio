using LocalMovies.Server.Api.Application.Commands;
using LocalMovies.Server.Api.Endpoints.Models;
using LocalMovies.Server.Api.Application.Queries;

using MediatR;

using Microsoft.AspNetCore.Mvc;

namespace LocalMovies.Server.Api.Endpoints;
...
public static class ConfigureDirectoryEndpoints
{
    ...
    {
        var result = await mediator.Send(new GetDirectoriesQuery());
